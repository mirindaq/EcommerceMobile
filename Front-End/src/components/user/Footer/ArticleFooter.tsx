    ...
    <footer className="bg-[#283038] text-sm text-gray-300 mt-10 border-t border-gray-700 font-sans">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-6 pb-6 pt-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            >
              <svg
                className="w-7 h-7 bg-black p-1 rounded-full"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#" className="hover:text-white transition-colors">
                Chính sách bảo mật thông tin người sử dụng
              </a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors">
        ...
        <div>
          ...
          {/* Cellphone S */}
          <p className="text-xs text-gray-400 mb-1 mt-4">
            Hệ thống bán lẻ di động toàn quốc.
          </p>
          <a
            href="#"
            className="bg-red-600 text-white inline-block px-3 py-1 rounded font-bold text-sm uppercase tracking-wider hover:opacity-90 transition-opacity"
          >
            cellphone S
          </a>
        ...
        <div>
          ...
          <h3 className="font-semibold mb-2 text-white opacity-0 pointer-events-none">
            DỊCH VỤ KHÁC
          </h3>
          ...
          <a
            href="#"
            className="bg-blue-900 text-white inline-block px-3 py-1 rounded font-bold text-sm uppercase tracking-wider hover:opacity-90 transition-opacity"
          >
            care S
          </a>
        </div>
      ...
      <div className="bg-[#1F252B] py-6 text-center text-xs text-gray-400 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 space-y-2">
          <p>
            © Công Ty TNHH Thương Mại Và Dịch Vụ Kỹ Thuật Diệu Phúc - GPBKKD:
            ...
            ngày 17/7/2021 - Địa chỉ: 350-352 Võ Văn Kiệt, Phường Cầu Ông Lãnh,
            Thành phố Hồ Chí Minh - Điện thoại: 028.7108.9666.
          </p>
          <p className="mb-4">
            Bản quyền nội dung thuộc về Sforum (hoặc Công Ty TNHH Thương Mại Và
            Dịch Vụ Kỹ Thuật Diệu Phúc). Không được sao chép khi chưa được chấp
            thuận bằng văn bản.
          </p>
          ...
          <div className="flex justify-center pt-4">
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.src =
                  "https://placehold.co/100x40/333333/FFFFFF?text=DMCA+Protected";
              }}
            />
          </div>
        </div>
